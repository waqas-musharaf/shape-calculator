...
{
    public partial class SquareArea : Form
    {
        public SquareArea()
        {
            InitializeComponent();
        ...
        private void SquareArea_Load(object sender, EventArgs e)
        {
        ...
        private void btnCalculate_Click(object sender, EventArgs e)
        {
            if (!tbLength.Text.Equals(""))
            {
                ...
                if (!r.IsMatch(tbLength.Text))
                {
                    ...
                    {
                        // Calculate area and fill tbArea
                        tbArea.Text = Square.GetArea(length).ToString();
                    }
                    else
                    {
